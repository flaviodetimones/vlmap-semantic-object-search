...
modelo real con el piloto de 200 imágenes, por ejemplo 30 épocas a
\texttt{imgsz=640} y \texttt{batch=2}, y compararlo contra YOLOE base. Si mejora
recall sin disparar falsos positivos, se escala a un dataset de mayor tamaño
(por ejemplo 1500--3000 imágenes) manteniendo la misma escena de fondos para
entrenamiento y reservando escenas distintas para evaluación end-to-end.
...
\input{project_status_and_plan_diary.tex}
