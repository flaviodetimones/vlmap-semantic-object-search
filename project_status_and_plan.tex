...
\begin{enumerate}
  ...
  \item \textbf{Prueba manual desde el menú}: abrir \texttt{menu}
        ...
        $\rightarrow$ \texttt{l) Interactive LLM navigation}. Para probar la
        exploración activa, lanzar antes en el mismo terminal:
        \texttt{export VLMAPS\_ROOM\_EXPLORATION=1}. Para desactivarla:
        \texttt{unset VLMAPS\_ROOM\_EXPLORATION}.
\end{enumerate}
