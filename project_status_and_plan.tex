...
G & LLM estratégico con estado & B + C + F & 2 sesiones \\
H & Métricas de evaluación & F & 1 sesión \\
\midrule
  & \textbf{Esfuerzo restante estimado} & & \textbf{3 sesiones} \\
\bottomrule
\end{tabular}
\end{center}
...
\textbf{Estado actual}: \textcolor{partialcol}{implementación inicial lista,
comparativa pendiente}. El trabajo restante se centra en lanzar ambos
entrypoints sobre el mismo lote de \emph{queries}, recoger métricas y
documentar las diferencias cualitativas de heatmap y trayectoria.
