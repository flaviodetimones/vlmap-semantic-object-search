...
\begin{enumerate}
  ...
  \item \textbf{Circuito fijo por habitación con disparo en ruta}: la opción
        ...
        defecto, 8. La generación de puntos reparte esos hitos por sectores
        angulares de la región navegable, forzando un circuito que recorra el
        perímetro útil de la habitación en vez de concentrarse en la zona
        central. Mientras el robot recorre ese circuito, YOLOE sigue
        vigilando en segundo plano con umbral bajo 0.40: si aparece una
        detección, la ruta se pausa, se abandona temporalmente el punto del
        circuito y el robot intenta acercarse por espacio navegable hacia la
        mejor celda semántica del objetivo dentro de esa misma habitación.
        Sólo acepta el hallazgo si logra confirmarlo desde cerca con un umbral
        fuerte de 0.80. Si no hay disparo en ruta, al llegar a cada punto hace
        un barrido lateral $\pm 30^\circ$ y pasa al siguiente.
\end{enumerate}
