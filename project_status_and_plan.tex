...
\begin{enumerate}
  ...
  \item \textbf{Puntos de exploración proporcionales al área}: la opción
        \texttt{x} interpreta los 8 puntos por defecto como el número de puntos
        para una habitación de tamaño típico $n$. El sistema calcula la mediana
        de área navegable de las regiones LabelMe de la escena y escala
        linealmente: $2n \rightarrow 16$ puntos,
        $0{,}75n \rightarrow 6$ puntos. La selección usa muestreo distribuido
        para cubrir la región, no sólo puntos centrales.
\end{enumerate}
