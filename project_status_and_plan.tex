...
\begin{enumerate}
  ...
  \item \textbf{Corrección del giro hacia objetivo}: la rutina
        ...
        del planificador: \(0^\circ\) mira hacia el norte del mapa y los
        ángulos positivos corresponden a giro a la derecha. Antes mezclaba
        otra convención y podía orientar la cámara hacia el lado opuesto del
        objeto detectado.
