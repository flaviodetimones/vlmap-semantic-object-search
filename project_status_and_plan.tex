...
\begin{enumerate}
  ...
  \item \textbf{Circuito fijo por habitación}: la opción \texttt{x} vuelve a un
        número fijo de puntos por habitación; por defecto, 8. La generación de
        puntos sigue usando muestreo distribuido para cubrir la región, pero
        ahora los ordena como un circuito alrededor de la propia habitación y
        ya no dispara YOLOE durante el trayecto. La detección se hace sólo al
        llegar a cada punto, mediante un barrido lateral $\pm 30^\circ$, antes
