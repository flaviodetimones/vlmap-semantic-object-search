...
\begin{enumerate}
  ...
  \item \textbf{Circuito fijo por habitación con disparo en ruta}: la opción
        ...
        defecto, 8. La generación de puntos reparte esos hitos sobre una
        rejilla que cubre la región navegable, aplica una separación mínima
        explícita entre puntos (\texttt{VLMAPS\_EXPLORE\_POINT\_MIN\_SEP\_M},
        0,90\,m por defecto) y después los ordena como circuito. Si no caben
        todos los puntos con esa separación, la distancia se relaja
        progresivamente y se imprime el valor usado. Esto evita que una
        habitación alargada concentre todos los puntos en el centro o deje sin
        cubrir una esquina útil. Mientras el robot recorre ese circuito, YOLOE
        sigue vigilando con umbral bajo
