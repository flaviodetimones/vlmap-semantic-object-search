...
\begin{enumerate}
  ...
  \item \textbf{Circuito fijo por habitación con disparo en ruta}: la opción
        ...
        defecto, 8. La generación de puntos sigue usando muestreo distribuido
        para cubrir la región y los ordena como un circuito alrededor de la
        propia habitación. Mientras el robot recorre ese circuito, YOLOE sigue
        vigilando en segundo plano: si aparece una detección, la ruta se pausa,
        el robot se acerca por espacio navegable y sólo acepta el hallazgo si
        logra confirmarlo desde cerca con un umbral fuerte de 0.80. Si no hay
        disparo en ruta, al llegar a cada punto hace un barrido lateral
        $\pm 30^\circ$ y pasa al siguiente.
\end{enumerate}
