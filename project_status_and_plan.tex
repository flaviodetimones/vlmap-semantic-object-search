...
\begin{enumerate}
  ...
  \item \textbf{Circuito fijo por habitación con disparo en ruta}: la opción
        ...
        rejilla que cubre la región navegable y después los ordena como
        circuito. Esto evita que una habitación alargada concentre todos los
        puntos en el centro o deje sin cubrir una esquina útil. Mientras el
        robot recorre ese circuito, YOLOE sigue vigilando con umbral bajo
